...
class TextCollectionTest < ActiveSupport::TestCase

  # test "check get review return array as is" do
    # review_text = ["The sweet potatoes in the vegetable bin are green with mold."]    
    # instance = TextCollection.new
    # result = instance.get_review(0, review_text)
...
#   
  ...
  test "read patterns - check numbers" do
    ...
    patterns = instance.read_patterns("/Users/lakshmi/Documents/Thesis/Ruby-test/content-patterns/patterns-assess.csv", pos_tagger)
  ...
  test "read patterns - check state negative" do
    instance = TextCollection.new
    pos_tagger = EngTagger.new
    patterns = instance.read_patterns("/Users/lakshmi/Documents/Thesis/Ruby-test/content-patterns/patterns-prob-detect.csv", pos_tagger)
  ...
  test "read patterns - check state suggestive" do
    instance = TextCollection.new
    pos_tagger = EngTagger.new
    patterns = instance.read_patterns("/Users/lakshmi/Documents/Thesis/Ruby-test/content-patterns/patterns-suggest.csv", pos_tagger)
